import { fetchDummyJsonProducts, pingDummyJson } from '@core/api/dummyJsonApi';
import { fetchFakeStoreProducts, pingFakeStore } from '@core/api/fakeStoreApi';
import { fetchSocialBuzzScore, isYoutubeKeyConfigured } from '@core/api/youtubeApi';
import { fetchAmazonBestSellers, fetchAmazonDeals, isAmazonKeyConfigured, pingAmazon } from '@core/api/amazonApi';
import { fetchBestBuyProducts, isBestBuyKeyConfigured, pingBestBuy } from '@core/api/bestBuyApi';
import { fetchRedditBuzzByCategory } from '@core/api/redditMarketApi';
