...
const WormDot: React.FC<{ index: number; scrollX: Animated.SharedValue<number>; screenW: number }> = ({
  index, scrollX, screenW,
}) => {
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.footerCard}>
          ...
          <View style={styles.dotsRow}>
            {SLIDES.map((_, i) => (
              <WormDot key={i} index={i} scrollX={scrollX} screenW={SCREEN_W} />
            ))}
          </View>
